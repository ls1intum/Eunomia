    ...
    def start(self):
        try:
            ...
            while True:
                ...
                for email in emails:
                    classification, confidence = self.email_classifier.classify_email(email)
                    self.handle_classification(email, classification, confidence)
